...
smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_ajax_options_", [smalltalk.send(smalltalk.send(unescape("https%3A//api.github.com/users/"), "__comma", [smalltalk.send(self, "_username", [])]), "__comma", [unescape("/repos")]), smalltalk.HashedCollection._fromPairs_([smalltalk.send("type", "__minus_gt", ["GET"]),smalltalk.send("success", "__minus_gt", [(function(repositoryData, status, jqXHR){return smalltalk.send(self, "_renderRepositories_On_", [repositoryData, html]);})]),smalltalk.send("error", "__minus_gt", [(function(jqXHR, textStatus, errorThrown){smalltalk.send(html, "_p_", [smalltalk.send(smalltalk.send(smalltalk.send("none found: ", "__comma", [smalltalk.send(textStatus, "_printString", [])]), "__comma", [" : "]), "__comma", [smalltalk.send(errorThrown, "_printString", [])])]);return smalltalk.send(html, "_p_", [unescape("Works%20from%20my%20laptop%2C%20but%20not%20from%20GitHub%20pages%3F%3F%3F")]);})])])]);
return self;},
args: ["html"],
source: unescape('renderOn%3A%20html%0A%0A%09html%20p%20with%3A%20%5B%3Ah%20%7C%20%20%0A%09%09h%20with%3A%20%27Hi%20there%2C%20world.%20This%20page%20is%20powered%20by%20%27.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20a%20href%3A%20%27http%3A//amber-lang.net/%27%3B%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20with%3A%20%27Amber%20Smalltalk%27.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%20with%3A%20%27.%27%5D.%0A%20%20%20%20%20%20%20%20html%20p%20with%3A%20%5B%3Ah%20%7C%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%20with%3A%20%27If%20you%27%27re%20new%20to%20Smalltalk%2C%20take%20an%20%27.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20a%20href%3A%20%27amber/learn.html%27%3B%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20with%3A%20%27Amber-powered%20Smaltalk%20tutorial%27.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%20with%3A%20%27%20right%20in%20your%20own%20browser%21%27%5D.%0A%09html%20p%20with%3A%20%5B%3Ah%20%7C%0A%09%09h%20with%3A%20%27The%20list%20of%20repositories%20below%20is%20generated%20by%20making%20calls%20to%20the%27.%0A%09%09h%0A%09%09%09a%20href%3A%20%27http%3A//developer.github.com/%27%3B%0A%09%09%09with%3A%20%27%20GitHub%20development%20API%27.%0A%09%09h%20with%3A%20%27%20from%20Amber%20Smalltalk.%27%20%5D.%0A%20%20%20%20%20%20%20%20html%20p%20with%3A%20%5B%3Ah%20%7C%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%20with%3A%20%27If%20you%20want%20to%20see%20how%20this%20is%20done%3A%20%27%20.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20h%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20button%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20with%3A%20%27Browse%20the%20%27%2C%20self%20class%20name%2C%20%27%20class%27%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20onClick%3A%20%5B%20Browser%20openOn%3A%20self%20class%20%5D.%0A%20%20%20%20%09%09h%20with%3A%20%27.%27%5D.%0A%09html%20p%3A%20%27If%20I%20were%20any%20kind%20of%20a%20web%20developer%20%28Smalltalk%20is%20my%20game%29%20this%20page%20would%20look%20a%20lot%20prettier.%27.%0A%09html%20strong%3A%20%27Repositories%27.%0A%09jQuery%20%0A%09%09ajax%3A%20%27https%3A//api.github.com/users/%27%2C%20self%20username%2C%20%27/repos%27%0A%09%09options%3A%20%23%7B%09%0A%09%09%09%27type%27%20-%3E%20%27GET%27.%0A%09%09%09%27success%27%20-%3E%20%5B%3ArepositoryData%20%3Astatus%20%3AjqXHR%20%7C%20self%20renderRepositories%3A%20repositoryData%20On%3A%20html%20%20%5D.%0A%20%20%20%20%20%09%09%09%27error%27%20-%3E%5B%3AjqXHR%20%3AtextStatus%20%3AerrorThrown%20%7C%20%0A%09%09%09%09html%20p%3A%20%27none%20found%3A%20%27%2C%20textStatus%20printString%2C%20%27%20%3A%20%27%2C%20errorThrown%20printString.%0A%09%09%09%09html%20p%3A%20%27Works%20from%20my%20laptop%2C%20but%20not%20from%20GitHub%20pages%3F%3F%3F%27%20%20%5D%7D%0A%09%0A'),
messageSends: ["with:", "p", "href:", "a", unescape("%2C"), "name", "class", "onClick:", "openOn:", "button", "p:", "strong:", "ajax:options:", "username", unescape("-%3E"), "renderRepositories:On:", "printString"],
